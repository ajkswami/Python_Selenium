...
class TestNetlifyform():
  ...
  def test_netlifyform(self):
    ...
    self.driver.find_element(By.ID, "fname").send_keys("Kedar")
    self.driver.find_element(By.ID, "lname").click()
    self.driver.find_element(By.ID, "lname").send_keys("Swamy")
    ...
    self.driver.find_element(By.NAME, "Options").send_keys("Chocolate")
    self.driver.find_element(By.NAME, "Options").click()
    self.driver.find_element(By.NAME, "Options").click()
    self.driver.find_element(By.NAME, "Options").click()
    self.driver.find_element(By.XPATH, "//form/fieldset").click()
    self.driver.find_element(By.ID, "favcolor").click()
    self.driver.find_element(By.ID, "favcolor").send_keys("#1b6364")
    self.driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(1)").click()
    self.driver.find_element(By.ID, "day").click()
    self.driver.find_element(By.ID, "day").send_keys("2023-12-17")
    self.driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(1)").click()
    ...
    self.driver.find_element(By.ID, "a").send_keys("81")
    ...
    element = self.driver.find_element(By.NAME, "message")
    actions = ActionChains(self.driver)
    actions.double_click(element).perform()
    self.driver.find_element(By.NAME, "message").click()
    self.driver.find_element(By.NAME, "message").send_keys("Testing done")
    self.vars["window_handles"] = self.driver.window_handles
    self.driver.find_element(By.CSS_SELECTOR, ".btn").click()
    self.vars["win3348"] = self.wait_for_window(2000)
    self.vars["root"] = self.driver.current_window_handle
    self.driver.switch_to.window(self.vars["win3348"])
